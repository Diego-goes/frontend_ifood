...
export default {
    ...
    async created() {
        ...
        // console.log(token)
        let usuarioId = await this.puxarDados(`https://backendhifood-production.up.railway.app/usuarios/ler/telefone/${IdUsu}`, 'GET' ,token)
        console.log(usuarioId)
        // for (let rota of this.rotas) {
        //     try {
        //         rota.data = await this.puxarDados(rota.url);
        //     } catch (error) {
        //         console.log(error)
        //     }
        // }  
