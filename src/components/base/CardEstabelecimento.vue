<template>
    <div class="cardEstabelecimentos">
        ...
        <img class="mainImage" :src="this.imagemPathProps" alt="">
        <div class="mainCard">
            <p>{{ this.nomeEstabProps }}</p>
            <small>{{ this.nomeCategoriaProps }}</small>
        </div>
        <div>
